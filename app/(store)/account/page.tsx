        ...
        >
          {MENU_ITEMS.map((item, i) => (
            ...
            >
              ...
              <span className="flex-1 font-medium text-sm text-on-surface">{item.label}</span>
        ...
        >
          <div className="flex items-center justify-between px-4 py-3.5" style={{ borderBottom: '1px solid var(--beige)' }}>
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-sm text-on-surface">آخر الطلبات</h3>
            </div>
          ...
          {recentOrders.length === 0 ? (
            <div className="py-10 text-center">
              ...
              <p className="text-sm mb-4 text-on-surface-variant">لا توجد طلبات بعد</p>
            ...
            <div>
              {recentOrders.map((order, i) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-beige">
                      <CubeIcon className="w-5 h-5 text-primary" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-sm text-on-surface" dir="ltr">{order.order_number}</p>
