  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-20">
      ...
      <div className="space-y-8 text-sm leading-8 opacity-80">
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">١. المعلومات التي نجمعها</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٢. كيف نستخدم معلوماتك</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٣. حماية بياناتك</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٤. ملفات تعريف الارتباط (Cookies)</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٥. حقوقك</h2>
        ...
        <section>
          ...
          <p>لأي استفسار حول خصوصيتك: <a href="mailto:contact@deepbeauty.kw" className="text-primary">contact@deepbeauty.kw</a></p>
        </section>
      </div>
    </main>
  )
