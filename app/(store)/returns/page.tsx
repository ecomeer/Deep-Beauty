  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-20">
      ...
      <div className="space-y-8 text-sm leading-8 opacity-80">
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">١. شروط الاسترجاع</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٢. حالات لا يُقبل فيها الاسترجاع</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٣. المنتجات التالفة أو الخاطئة</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٤. كيفية الاسترجاع</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٥. رسوم الاسترجاع</h2>
