  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-20">
      ...
      <div className="space-y-8 text-sm leading-8 opacity-80">
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">١. القبول بالشروط</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٢. المنتجات والأسعار</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٣. الطلبات والدفع</h2>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-primary">٥. الملكية الفكرية</h2>
